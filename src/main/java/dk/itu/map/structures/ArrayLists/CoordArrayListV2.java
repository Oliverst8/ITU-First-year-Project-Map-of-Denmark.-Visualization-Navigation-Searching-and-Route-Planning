...
public class CoordArrayListV2 extends PrimitiveArrayList {
     ...
     * @param init_size
     */
    public CoordArrayListV2(int init_size) {
        super();
     ...
     * @param array
     */
    public CoordArrayListV2(float[] array) {
